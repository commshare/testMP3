...
int main(int argc, const char **argv) try
{
	...
	if (argc > 1)
	{
		...
		std::string cli_arg = "e:/U2L1-3006-BGM-ToyShop.mp3";
	...
	else
	{
        ...
        // In-memory Mp3
		std::string one = "test_data/ad_hoc/acetylene.mp3";
		std::string two = "test_data/U2L1-3006-BGM-ToyShop.mp3";
        auto memory = ReadFile(two);
